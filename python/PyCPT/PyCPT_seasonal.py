...
def run_pycpt_seasonal(region, spatial_predictors, spatial_predictands, models, obs, station, mos, predictand, predictor, mons, tgtii, tgtff, tini, tend,
        ...
        #models = ['COLA-RSMAS-CCSM4','NASA-GEOSS2S','NCEP-CFSv2']
        models = models
        ...
        # mons=['Dec']
        tgtii = tgtii #['0.5', '3.5']  # S: start for the DL
        tgtff = tgtff #['2.5', '5.5']  # S: end for the DL
        #tgts = tgts
        ...
        tini = tini #1993
        tend = tend #2016
        xmodes_min = xmodes_min #1
        xmodes_max = xmodes_max #8
        ymodes_min = ymodes_min #1
        ymodes_max = ymodes_max #6
        ccamodes_min = ccamodes_min #1
        ccamodes_max = ccamodes_max #4
        # Forecast date
        ...
        sla1=spatial_predictors[1] #4	# Southernmost latitude
        wlo1=spatial_predictors[2] #26 	# Westernmost longitude
        elo1=spatial_predictors[3] #52 	# Easternmost longitude
        # # Spatial domain for predictand
        nla2=spatial_predictands[0] #16 	# Northernmost latitude
        sla2= spatial_predictands[1] #2 	# Southernmost latitude
        wlo2= spatial_predictands[2]# 30 	# Westernmost longitude
        elo2=spatial_predictands[3] #50 	# Easternmost longitude
