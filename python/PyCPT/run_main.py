from PyCPT_script import *
import sys

region = sys.argv[1]
# Setting format
spatial_predictors_string = sys.argv[2].split(",")
spatial_predictors = []
...
spatial_predictands_string = sys.argv[3].split(",")
spatial_predictands = []
...
obs = sys.argv[5]
print(type(obs), obs)
station = True if sys.argv[6] == 'TRUE' else False
print(type(station), station)
mos = sys.argv[7]
print(type(mos), mos)
predictand = sys.argv[8]
print(type(predictand), predictand)
predictor = sys.argv[9]
print(type(predictor), predictor)
mons = sys.argv[10].split(",")
print(type(mons), mons)
tgtii = sys.argv[11].split(",")
print(type(tgtii), tgtii)
tgtff = sys.argv[12].split(",")
print(type(tgtff), tgtff)
tgts = sys.argv[13].split(",")
